...
class ProgrammeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.programmes_list_endpoint = _Endpoint(
            settings={
                'response_type': ([Programme],),
                'auth': [
                    'Token'
                ],
                'endpoint_path': '/programmes/rechercher/',
                'operation_id': 'programmes_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def programmes_list(
        ...
        **kwargs
        ...
        """programmes_list  # noqa: E501

        Search programs  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.programmes_list(annee, codes, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['codes'] = \
            codes
        return self.programmes_list_endpoint.call_with_http_info(**kwargs)
